...
![AUR version](https://img.shields.io/aur/version/mint-backgrounds-tara?label=AUR)
[![Build Status](https://drone.cryptic.systems/api/badges/volker.raschek/mint-backgrounds-tara-pkg/status.svg)](https://drone.cryptic.systems/volker.raschek/mint-backgrounds-tara-pkg)
![AUR votes](https://img.shields.io/aur/votes/mint-backgrounds-tara)

This repository contains build files to build the Arch Linux package `mint-backgrounds-tara`. Instead of building the
...
```bash
git clone https://aur.archlinux.org/mint-backgrounds-tara.git
cd mint-backgrounds-tara
makepkg
```
...
```bash
yay --sync --aur mint-backgrounds-tara
```
...
sudo pacman --sync mint-backgrounds-tara
```
